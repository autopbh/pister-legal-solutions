  ...
  return (
    <section className="section-padding bg-gradient-professional relative overflow-hidden">
      ...
      <div className="container mx-auto container-padding relative z-10">
        ...
        {/* Principal Lawyer */}
        <div className="mb-20">
          <Card className="card-luxury p-8 md:p-12 max-w-4xl mx-auto animate-scale-in">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-xl text-accent font-semibold mb-4">{t.team.founder.role}</p>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {t.team.founder.specialties.map((specialty, i) => (
                      <span
                        key={i}
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-primary-foreground/80">{t.team.founder.location}</span>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {t.team.founder.qualifications.map((qual, i) => (
        ...
        <div>
          <h3 className="font-playfair text-3xl font-bold text-primary text-center mb-12">
            {t.team.associates.title}
          </h3>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {t.team.associates.members.map((associate, index) => (
              <Card
                key={index}
