...
export const translations: Record<string, Translations> = {
  ...
  fr: {
    ...
    services: {
      ...
      subtitle: "Conseil juridique complet dans tous les domaines du droit international et commercial avec expertise et service personnalisé",
      international: {
      ...
      whyUs: "Pourquoi Cabinet Pister?",
      benefits: {
        expertise: {
          title: "Expertise Internationale",
          description: "Compétence locale avec compréhension globale"
        },
        multilingual: {
          title: "Conseil Multilingue",
          description: "Communication fluide en 4 langues"
        },
        experience: {
      ...
      consultation: {
        ...
        subtitle: "Sans engagement & professionnelle",
        description: "Profitez de notre consultation gratuite pour une première évaluation de votre question juridique.",
        duration: "30min",
        response: "24h",
